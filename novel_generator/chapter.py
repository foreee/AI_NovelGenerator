...
from novel_generator.vectorstore_utils import load_vector_store  # 添加导入
...
def build_chapter_prompt(
    ...
    # 获取前文内容和摘要
    recent_texts = get_last_n_chapters_text(chapters_dir, novel_number, n=5)
    ...
    print(f"[DEBUG] short_summary: {short_summary}")
    # 返回最终提示词
